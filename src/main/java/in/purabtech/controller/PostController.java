...
public class PostController {
    ...
    public String newPost(Principal principal,
        ...
        if (user.isPresent()) {
            ...
            /*post.setTitle("test22 test22 test22 test22 test22");
            post.setBody("ddddd ddddddddddd");
    ...
    public String editPostWithId(@PathVariable Long id,
        ...
        if (optionalPost.isPresent() || true) {
            Post post = optionalPost.get();

            if (isPrincipalOwnerOfPost(principal, post) || true) {
                model.addAttribute("post", post);
                return "/postForm";
            } else {
                return "/403";
